document.addEventListener('DOMContentLoaded', () => {
  ...
  function createNote(
    ...
    note_card.innerHTML = `
      ...
      <div class="note-card-info">
        ...
        <!-- <input type="checkbox" id="note-complete" /> -->
        </div>
      </div>
    `;
  ...
  // these are some styles for complete notes checkbox
//  const checkbox = {
//    position: 'absolute',
//    top: '20px',
//    right: '20px',
...
//    MozAppearance: 'none',
//  };
// function applyStylesToCheckbox(element, styledObject) {
//   if (!element || !styledObject) return;

//   Object.entries(styledObject).forEach(([key, value]) => {
//     element.style[key] = value;
//   });
// }

// applyStylesToCheckbox(document.getElementById('note-complete'), checkbox);
});
